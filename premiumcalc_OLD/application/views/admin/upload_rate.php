	...
	<div class="container">
		...
		<div class="content">
			<div class="edit-policy" style="border:0px solid #000;">
				<ul>
					<fieldset>
						<legend>Policy Rate File</legend><br>
						<label>Policy Rate File (old) : </label><a href="<?=base_url();?>sysfiles/policy_rates/policy_rate_<?=$policy['policy_id']; ?>.csv">Click here to download !!</a><br><br><br>
					...
					<form method="POST" enctype="multipart/form-data" action="" id="upload_rate" name="upload_rate" >
						<fieldset>
							<legend>Upload Policy Rate</legend><br>
							<li>
				...
				<fieldset>
					...
					<tbody>
						...
						{
							echo '<tr colspan="4"><td><div class="err_msg" style="font-size:16px;">Please Set Policy Rate</div></td></tr>';
						}
						?>
					</tbody>
				</table>
