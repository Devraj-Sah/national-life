...
$(document).ready(function() {
  ...
  $("#create").click(function(event) {
    if($("#curr_psswrd").val()==''||$("#new_email").val()=='')
    {
  ...
  <form action="" method="POST" id="change_password">
    <table>
      <tbody>
        ...
        <tr class="spaceUnder">
          <td><label for="psswrd">New Email <span class="req">*</span></label></td>
          <td><input type="text" name="new_email" id="new_email" class="input_field"></td>
        </tr>
        <tr>
          <td></td>
