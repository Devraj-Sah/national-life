    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-3">
                ...
                <ul class="sidelist">
                    <li>&RightVector;<a href="">Premium Calculator</a></li>
...
<?php } ?>          
                    <li>&RightVector;<a href="http://202.166.205.74:8080/" target="_blank">Foreign Employment Term Policy Enquiry</a></li>
                </ul>
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-6">
                ...
                <div class="news">
                    ...
                    ?>
                    <a href="<?php echo $url; ?>" class="text-center news-title">Notice</a>
                    <ul>
                        <?php
                        while ($row = $conn->fetchArray($result)) {
                            ?>
...
<?php } ?>
            ...
            <div class="col-xs-12 col-sm-6">
                ...
                <div class="building">
                    <div class="text-center news-title building-title">New Building</div>
