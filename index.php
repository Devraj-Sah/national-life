                        ...
                        <div class="col-xs-12 visible-xs">
                            <div class="row">
                                <aside class="logo col-xs-12 text-center" style="margin:10px 0px;">
                                    <header>
                                        <h1>
                                            <a href="home" class="clearfix" title="National Life Insurance Company Limited">
                                                <img class="logo-img" src="img/logo.png"  alt="National Life Insurance Company Limited"/>
                                            </a>
                                        </h1>
                                    </header>
                                </aside>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-12">
                                            <div class="head-Links">
                                                ...
                                                ?>
                                                 <a href="https://member.nationallife.com.np/foreignEmpInquiry" target="_blank">Term Policy Enquiry</a>
                                            </div>
                                        </div>
                                        <div class="col-xs-12">
                                            <div class="row">
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-8">
                            <aside class="logo">
                                <header><h1><a href="" class="clearfix" title="National Life Insurance Company Limited"><img src="img/logo.png" class="logo-img" alt="National Life Insurance Company Limited"/></a></h1></header>
                            </aside>
                        </div>
