...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <base href="https://<?php echo BASELOCATION; ?>">
  ...
  padding-left: 10px;
    ...
    <body onLoad="goforit()">
        ...
        <?php
            ...
            while ($row = $conn->fetchArray($result)) {
                if (!empty($row['image']) && file_exists(CMS_GROUPS_DIR . $row['image'])) {
                    ...
                    <div class="popup">
                        ...
                        <a href="<?php echo $row['shortcontents']; ?>">
            ...
            //THIS IS UPDATED FOR SECOND POPUP
            $id2 = $constant->getId(101);
            $result2 = $groups->getById($id2);

            while ($row2 = $conn->fetchArray($result2)) {

                if (!empty($row2['image']) && file_exists(CMS_GROUPS_DIR . $row2['image'])) {
                    $size2 = getimagesize(CMS_GROUPS_DIR . $row2['image']);

                    ?>
                    <div class="popOverlay2"></div>
                    <div class="popup2">
                        <span class="popup-cross2 pull-right">&cross;</span>

                        <div style="padding:25px; position:absolute; top:0px;"><?php echo $row2['contents']; ?></div>
                        <a href="<?php echo $row2['shortcontents']; ?>">
                        <img src="<?php echo CMS_GROUPS_DIR . $row2['image']; ?>" class="img-responsive" alt="">
                        </a>
                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-12">
                                            <div class="head-Links">
                                                ...
                                                ?>
												 <a href="http://202.63.241.59:15314/foreignEmpInquiry" target="_blank">Term Policy Enquiry</a>
                                            </div>
                                        </div>
                                        <div class="col-xs-12">
                                            <div class="row">
                                ...
                                <div class="col-xs-12">
                                    <div class="row">
                                        <div class="col-xs-12 english_nepali text-right">
                                            <div class="clearfix">
                                                <a href="http://nationallife.com.np" class="english" title="English">English</a>\ <a href="#" class="english" title="English">नेपाली </a>
                                            <!--<a href="nepali/" class="nepali" title="Nepali">nepali</a>-->
                                            </div>
                                        </div>
                                        <div class="col-xs-12">
                                            <div class="head-Links">
                                                ...
                                                ?>
                                                <a href="http://202.63.241.59:15314/foreignEmpInquiry" target="_blank">वैदेशिक रोजगार म्यादी बीमा</a>
                                            </div>
                                        </div>
                    ...
                    <div class="col-sm-12  footer_link">
                        <div class="row list">
                            <aside class="col-xs-12 col-sm-3 ">
                                ...
                                <h3>सम्बन्धित लिन्क</h3>
                                <ul>
                                    
                                 
                                        <li><a href="http://nationallife.com.np/faq" title="#"><span>&mstpos;</span>प्राय: सोधिने प्र्शनहरु</a></li>
                                        <li><a href="<?php echo $row['urlname']; ?>?action=showsitemap" title="#"><span>&mstpos;</span>साइट म्याप</a></li>
                                        <li><a href="http://nationallife.com.np/?action=feedback" title="#"><span>&mstpos;</span>तपाईँको प्रतिक्रिया</a></li>
                                        <li><a href="http://nationallife.com.np/download" title="#"><span>&mstpos;</span>डाउन्लोड</a></li>
...
<aside class="location col-xs-12 col-sm-3">
 ...
 <div class="building">
                    <div class="text-center news-title building-title">मुख्य कार्यालय </div>
...
<?php */ ?>
             ...
             <div class="row">
                    <div class="col-xs-12  col-sm-12 col-md-12 copyright">
                        <article style="text-align:center;">
                             <hr>
                            <span >
                                <a style="color:inherit;" href="<?php echo (SITE_ADDRESS); ?>board-of-directors" >संचालक समिति</a> | 
                                <a style="color:inherit;" href="<?php echo (SITE_ADDRESS); ?>व्यवस्थापन-समुह" >व्यवस्थापन समुह</a> | 
                                <a style="color:inherit;" href="http://nationallife.com.np/files/download/citizencharter.pdf" >नागरिक बदापत्र</a> | 

                                <a style="color:inherit;" href="<?php echo (SITE_ADDRESS); ?>?action=showsitemap" >साइट म्याप </a> | 
                                 <a style="color:inherit;" href="http://nationallife.com.np/first-policy" >प्रथम बीमलेख </a> |
                                <a style="color:inherit;" href="<?php echo (SITE_ADDRESS); ?>शाखाहरु" >सम्पर्क</a> | 
                                <a style="color:inherit;" href="<?php echo (SITE_ADDRESS); ?>संस्थागत-लक्ष्य" >संस्थागत  लक्ष्य </a> |
                                <a style="color:inherit;" href="<?php echo (SITE_ADDRESS); ?>notice" >सुचना</a> |
                                  <a style="color:inherit;" href="http://nationallife.com.np/?action=feedback" >तपाईँको प्रतिक्रिया </a> |
                                  <a style="color:inherit;" href="http://nationallife.com.np/financial" >वित्तीय विवरण</a> |
                                <a style="color:inherit;" href="http://nationallife.com.np/faq" >प्राय: सोधिने प्रश्नहरु </a> | 
                                <a style="color:inherit;" href="http://nationallife.com.np/training-seminar-workshop" >तालिम, सेमिनार, कार्यशाला </a>   </br>
                                <a style="color:inherit;" href="http://nationallife.com.np/contactus#location" >स्थान </a> |
                                <a style="color:inherit;" href="http://nationallife.com.np/agents-info" >बीमा अभिकर्ता </a> |
                                <a style="color:inherit;" href="http://nationallife.com.np/insurance-defaulters" >बीमा डीफल्टर </a> |
                                <a style="color:inherit;" href="http://nationallife.com.np/premiumcalc/" >बीमा क्याल्कुलेटर </a> 
                            </span>
    ...
    <script type="text/javascript">
            ...
            //          console.log(vpw);
                    ...
                    function resizeDiv2() {
                        vpw = $(window).width() / 2 - <?php echo $size2[0] / 2; ?> + 'px';
                        vph = $(window).height() / 2 - <?php echo $size2[1] / 2; ?> + 'px';
